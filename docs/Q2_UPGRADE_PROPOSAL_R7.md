...
\textbf{Systematic evaluation components}:  % R7 fix: P2-3 (Attack-R6-6)
\begin{itemize}
...
R4 方案的 CBM 接收概率估计为 29-37%（中值 33%），不是基于R3终审的锚定估计+边际影响分析，而是基于以下因素的综合判断：  <!-- R7 fix: P2-5 (Attack-R6-8) -->
